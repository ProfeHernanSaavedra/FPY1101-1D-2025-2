...
La opción 1 sólo deberá mostrar un mensaje exitoso en caso de haber iniciado correctamente, o un mensaje de error de caso contrario

5)	Cree un sistema de ventas de supermercado en el cual se pueda agregar produc-tos al carro de compras, las opciones del menú serán.
    1.	Agregar productos
    2.	Ver canasta
    3.	Ver total
    4.	Salir

    •	En agregar productos deberá mostrar un menú con 5 productos y sus pre-cios (creado por usted), cada vez que se seleccione un producto quedará agregado en la lista.
